...
pub fn solve() -> SolutionPair {
    (
        Solution::from(part_1(load_input("inputs/day_13").lines())),
        Solution::from(part_2(load_input("inputs/day_13").lines())),
    )
}
...
mod tests {
    ...
    #[test]
    fn test_part_1() {
        assert_eq!(part_1(load_input("inputs/day_13").lines()), 0);
    }
    ...
    #[test]
    fn test_part_2() {
        assert_eq!(part_2(load_input("inputs/day_13").lines()), 0);
    }
}
